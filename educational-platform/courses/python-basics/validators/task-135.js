export default class Task135PyValidator {
  async validate(pyCode, css, js, samples, config) {
    ...
    const checks = [
      ...
      {
        name: "Используется .isdigit()",
        label: "Используется .isdigit()",
        passed: /\.isdigit\s*\(/.test(pyCode),
      },
      {
        name: "Используется .isalpha()",
        label: "Используется .isalpha()",
        passed: /\.isalpha\s*\(/.test(pyCode),
      },
      {
