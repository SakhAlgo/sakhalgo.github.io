...
export default class Task052Validator {
    async validate(html, css, js, samples, config) {
        ...
        // Проверка 3: три элемента li внутри ul
        ...
        if (hasThreeLi) score += 20;

        // Проверка 4: текст "Яблоко" в первом li
        ...
        if (firstItem) score += 10;

        // Проверка 5: текст "Банан" во втором li
        ...
        if (secondItem) score += 10;

        // Проверка 6: текст "Апельсин" в третьем li
