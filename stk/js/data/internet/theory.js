...
<div class="internet-theory-module" id="top2">
    ...
    <section id="diagnostics">
        ...
        <ul>
            ...
            <li>
    <section id="mismatch" class="theory-section">
        <strong>Mismatch</strong>

        <div class="highlight-box" style="background: #fff1f0; border-left-color: #c42a2a;">
            <strong>⚠️ Mismatch (несмачка)</strong> — это <strong>перепутанные жилы</strong> внутри витой пары. Не путать с перепутанными парами местами: здесь речь именно о жилах <strong>внутри одной пары</strong>.
        </div>

        <strong>Что это</strong>
        <ul>
            <li>Чаще всего — перепутанные жилы.</li>
            <li>Не пары местами, а именно <strong>жилы внутри пары</strong>.</li>
        </ul>

        <strong>Пример</strong>
        <div class="comparison-grid">
            <div class="comparison-card blue">
                <h4 style="color: #1a5f7a;">✅ Как забиваем (правильно)</h4>
                <ul>
                    <li>бело-синее</li>
                    <li>синее</li>
                    <li>бело-оранжевое</li>
                    <li>оранжевое</li>
                </ul>
            </div>
            <div class="comparison-card" style="border-color: #c42a2a; background: #fff6f6;">
                <h4 style="color: #b21e1e;">❌ Что показывает замер</h4>
                <ul>
                    <li>бело-синее</li>
                    <li>синее</li>
                    <li><strong style="color: #b21e1e;">оранжевое</strong></li>
                    <li><strong style="color: #b21e1e;">бело-оранжевое</strong></li>
                </ul>
            </div>
        </div>
        <p>То есть жилы <strong>внутри пары</strong> поменяны местами — «ланка» это видит, но визуально на коннекторе можно и не заметить.</p>

        <h3>Что делать</h3>
        <ol class="algorithm-steps">
            <li>Внимательно смотреть порядок забития жил на парке.</li>
            <li>Использовать «ланку» в режиме <strong>cont</strong> (прозвонка).</li>
            <li>Сравнить фактический порядок с эталонным.</li>
            <li>Найти конкретное место, где жилы перепутаны, и переконечивать.</li>
        </ol>

        <strong>Важно</strong>
        <div class="warning-box">
            <strong>⚠️ Последствия mismatch:</strong>
            <ul style="margin-top: 8px; margin-bottom: 0;">
                <li>Если перепутаны жилы на парке или узле — будет <strong>просадка скорости</strong>.</li>
                <li>До <strong>100 Мбит/с</strong> может проваливаться.</li>
                <li>Если задействована оранжевая пара — скорость падает до <strong>10 Мбит/с</strong> (интернет фактически на трёх жилах).</li>
                <li>Надо найти конкретное место, где жилы перепутаны — и устранить.</li>
            </ul>
        </div>

        <div class="highlight-box" style="background: #eef4fa; border-left-color: #4a90d9;">
            <strong>💡 Совет:</strong> не доверяй только визуальному осмотру коннектора. Mismatch часто виден <strong>только «ланкой»</strong> в режиме cont — глазами порядок жил на обжатом коннекторе можно не разглядеть.
        </div>
    </section>
            </li>
            <li>
        ...
        <div class="highlight-box" style="background: #fff1f0; border-left-color: #c42a2a;">
            <strong>⚠️ Cross talk</strong> — это также <strong>плохой контакт</strong> в линии. Из-за него «ланка» может показывать некорректную длину кабеля — вплоть до «гуляющих» значений.
        </div>

        <strong>Что это</strong>
        <ul>
            <li>Плохой контакт.</li>
            <li>Может быть <strong>«гуляющий»</strong>: показывает 0 метров, 120 метров — хотя кабеля всего 40 метров.</li>
        </ul>

        <strong>Что делать</strong>
        <ol class="algorithm-steps">
            <li>Начинать <strong>от абонента</strong> и идти в обратную сторону.</li>
            <li>Выключать соединения <strong>по одному</strong> и искать, где конкретно проблема.</li>
            <li>Как только нашёл участок, на котором показания «ланки» приходят в норму — проблема здесь.</li>
        </ol>

        <div class="warning-box">
            <strong>💡 Совет из практики:</strong>
            <ul style="margin-top: 8px; margin-bottom: 0;">
                <li>Иногда спасает снять изоляцию и забить жилы металлом в модуль.</li>
                <li><strong>Но не оставлять оголённые жилы отдельно</strong> — это временная мера, а не решение.</li>
                <li>Всё равно нужно переконечивать нормально.</li>
            </ul>
        </div>

        <div class="highlight-box" style="background: #eef4fa; border-left-color: #4a90d9;">
            <strong>💡 Как отличить Cross talk от Mismatch:</strong><br>
            <strong>Mismatch</strong> — «ланка» показывает <strong>стабильно неправильный</strong> порядок жил (перепутаны внутри пары).<br>
            <strong>Cross talk</strong> — «ланка» показывает <strong>«гуляющую» длину</strong> (0 м, 120 м, 40 м) из-за плохого контакта. Порядок жил при этом может быть правильным.
        </div>
    </section>
            </li>
        </ul>
