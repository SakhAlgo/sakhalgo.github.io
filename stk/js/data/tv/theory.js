...
<div class="container" id="top">
    ...
    <div class="toc">
        ...
        <a href="#section17">Телевизоры: настройка и проблемы</a>
    </div>
    ...
    <section id="section11" class="theory-section">
        ...
        <ul>
            ...
            <li>При некачественном оптическом сигнале — проверка сварки оптоволокна, оптического сплиттера.</li>
                ...
                <!-- ===== ПОИСК ПЛАВАЮЩЕЙ ПРОБЛЕМЫ С СИГНАЛОМ ===== -->
        <h3 style="margin-top: 40px; border-left-color: #e67e22; padding-left: 14px; color: #b85a1a;">
            🔍 Порядок действий при поиске плавающей проблемы с сигналом
        </h3>

        <div class="highlight-box" style="background: #fff8e6; border-left-color: #f39c12;">
            <strong>⚠️ Плавающая проблема</strong> — это неисправность, которая проявляется периодически: сигнал то есть, то нет, картинка то рассыпается, то работает. Такие проблемы нельзя оставлять «как есть» — их обязательно нужно доводить до конца и устранять причину, а не симптом.
        </div>

        <h4>Шаг 1. Работа с абонентом</h4>
        <ul>
            <li>Звонишь абоненту и предупреждаешь, что сейчас будешь шевелить соединения.</li>
            <li>Просишь абонента смотреть телевизор в этот момент.</li>
            <li>Абонент сообщает, когда сигнал пропадает или рассыпается.</li>
        </ul>

        <h4>Шаг 2. Работа с техотделом (приёмник онлайн)</h4>
        <ul>
            <li>Звонишь Техам, те заходят на приёмник <strong>онлайн</strong> — именно онлайн, чтобы техотдел видел изменения в реальном времени.</li>
            <li>Техотдел смотрит, как ведёт себя сигнал в момент, когда ты шевелишь соединения.</li>
            <li>Если сигнал не скачет — проблема <strong>не в оптике</strong>.</li>
        </ul>

        <h4>Шаг 3. Шевеление соединений</h4>
        <p>Проверяются поочерёдно:</p>
        <ul>
            <li>Оптика на чердаке.</li>
            <li>Разводка на крыше.</li>
            <li>Сплиттеры.</li>
            <li>Коннекторы.</li>
        </ul>

        <h4>Шаг 4. Фиксация результата</h4>
        <ul>
            <li>Абонент смотрит ТВ и сообщает, когда сигнал пропадает.</li>
            <li>Если при касании сигнал рассыпался — проблема здесь.</li>
            <li>Если сигнал не реагирует — идёшь дальше по цепочке.</li>
        </ul>

        <div class="warning-box">
            <strong>⚠️ Важно:</strong>
            <ul style="margin-top: 8px; margin-bottom: 0;">
                <li>Плавающую проблему нельзя оставлять «как есть».</li>
                <li>Если додавил коннектор и сигнал появился — это <strong>временно</strong>. Нагреется, остынет — вылезет снова.</li>
                <li>Всё срезается и переконечивается.</li>
            </ul>
        </div>

        <h3>Работа с анализатором</h3>

        <h4>1. Зачем нужен анализатор</h4>
        <ul>
            <li>Сразу показывает ошибки и проблемы в кабеле.</li>
            <li>Позволяет не выключать диагностику и видеть изменения в реальном времени.</li>
            <li>Записывает всё, что происходило с кабелем за время проверки.</li>
        </ul>

        <h4>2. Схема подключения</h4>
        <ol class="algorithm-steps">
            <li>Ставишь сплиттер возле телевизора (<strong>204-й</strong>).</li>
            <li>Делишь сигнал пополам: один — на телевизор, один — на анализатор.</li>
            <li>Просишь абонента смотреть ТВ.</li>
            <li>Сам идёшь шевелить соединения.</li>
            <li>Смотришь, где начинается проблема.</li>
        </ol>

        <h4>3. Норма</h4>
        <ul>
            <li>При шевелении <strong>11-го кокса</strong> и <strong>816-го сплиттера</strong> ничего происходить не должно.</li>
            <li>Если что-то происходит — соединение уже раздолбано.</li>
        </ul>

        <h3>Правила монтажа и замены соединений</h3>

        <h4>1. Не оставляй временные соединения</h4>
        <ul>
            <li>Если повредился 11-й кокс на крыше — можно временно соединить 11-й с 11-м, но потом обязательно заменить.</li>
            <li>Соединение на крыше не оставляем: сегодня работает, завтра — нет.</li>
        </ul>

        <h4>2. Термоусадка — не решение</h4>
        <ul>
            <li>Некоторые закатывают соединение тёмной термоусадкой и заплавляют.</li>
            <li>Найти такое соединение можно только руками.</li>
            <li>Всё равно надо менять.</li>
        </ul>

        <h4>3. Плановая работа</h4>
        <ul>
            <li>Если нужно заменить защиту или соединение — оформляй заявку на плановую работу.</li>
            <li>Не оставляй «на потом».</li>
        </ul>
        <!-- ===== КОНЕЦ ПОИСКА ПЛАВАЮЩЕЙ ПРОБЛЕМЫ ===== -->
...
<!-- ============================================================ -->
    ...
    <!-- ==================== РАЗДЕЛ 17 ==================== -->
    <section id="section17" class="theory-section">
        <h2>Телевизоры: настройка и типовые проблемы</h2>

        <div class="highlight-box" style="background: #fff8e6; border-left-color: #f39c12;">
            <strong>📌 Главный принцип:</strong> если проблема на стороне телевизора абонента — <strong>как минимум настроить каналы и уйти</strong>. Не приходить и не говорить, что проблема нерешаемая. Хотя бы временно сделать так, чтобы телевизор работал.
        </div>

        <!-- ==================== 8.1 HIsense ==================== -->
        <h3 style="border-left-color: #e67e22; color: #b85a1a;">📺 Хайсенс (Hisense)</h3>

        <h4>Проблема</h4>
        <ul>
            <li>Чтение списка каналов. Может зависать, не переключать каналы.(Пока решения нет. Возможна работает с определенной прошивкой.). Если выключить из розетки, какое то время работает.</li>
        </ul>

        <h4>Что делать</h4>
        <ol class="algorithm-steps">
            <li>Как минимум — настроить каналы и уйти.</li>
            <li>Сказать абоненту, что проблему решить не можем (это особенность самого телевизора).</li>
            <li>Не приходить и не говорить, что проблема нерешаемая.</li>
            <li>Хотя бы временно сделать, чтобы телевизор работал.</li>
        </ol>

        <!-- ==================== 8.2 Samsung, LG и другие ==================== -->
        <h3 style="border-left-color: #2ecc71; color: #1a6b3a;">📺 Samsung, LG и другие</h3>

        <h4>1. Язык вещания</h4>
        <div class="warning-box">
            <strong>⚠️ Важно:</strong> вещание идёт на <strong>двух языках</strong> — английский и русский.
        </div>
        <ul>
            <li>При настройке проверяй, на каком языке говорит телевизор.</li>
            <li>Включай канал, который выключен, слушай язык.</li>
            <li>Не реклама — надо попасть на фильм.</li>
            <li>Найди языковые дорожки и переключи на русский.</li>
        </ul>

        <h4>2. Поиск каналов</h4>
        <ul>
            <li>Если автопоиск не находит все каналы — искать <strong>вручную</strong>.</li>
            <li>Частотная сетка: первая пачка — <strong>378 МГц</strong>, каждая следующая <strong>+8 МГц</strong>.</li>
            <li>В 474-й части канала нет — покажет <strong>0</strong>.</li>
            <li>Добавляй <strong>8</strong> и иди дальше.</li>
            <li>Если набрал пачку, нажал поиск — не нашёл: набери ещё раз, подожди <strong>10–15 секунд</strong>, нажми поиск.</li>
        </ul>

        <div class="highlight-box" style="background: #eef4fa; border-left-color: #4a90d9;">
            <strong>💡 Пример частотной сетки:</strong><br>
            378 → 386 → 394 → 402 → 410 → 418 → 426 → 434 → 442 → 450 → 458 → 466 → <span style="color:#b22222; font-weight:700;">474 (нет канала, покажет 0)</span> → 482 → 490 → 498 → 506
        </div>

        <h4>3. Автообновление</h4>
        <div class="warning-box">
            <strong>⚠️ Отключайте полностью автообновление!</strong> Особенно на телевизорах <strong>Sony</strong>.
        </div>
        <ul>
            <li>Если Sony не видит сигнал — через <strong>полчаса</strong> включается автообновление.</li>
            <li>Это сбивает настройки и мешает работе.</li>
        </ul>
    </section>
